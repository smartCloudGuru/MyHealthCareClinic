...
export default class Onl2FindAppointmentResultRow extends LightningElement {
    ...
    handleSchedule(event) {
        if (this.quantity > 0) {
            ...
            let appointment = {};
            for (let t of this.product.Default_Appointments__r.records)
            {
            ...
            this.dispatchEvent(new CustomEvent('add', {
                detail: {product: this.product, quantity: this.quantity, firstAvailable: firstAvailable, appointment: appointment, isBundle: this.isBundle}
            }));
        }
    }
