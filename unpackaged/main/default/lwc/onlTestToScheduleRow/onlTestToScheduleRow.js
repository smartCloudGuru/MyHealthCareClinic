...
export default class OnlTestToScheduleRow extends LightningElement {
    ...
    connectedCallback() {
        ...
        if (this.test && this.test.Scheduled_Appointment__r && this.test.Scheduled_Appointment__r.SchedStartTime)
        {
            ...
            //https://calendar.yahoo.com/?v=60&view=d&type=20&TITLE=Summary%20of%20the%20event&ST=20210505T170000&ET=20210505T190000&DESC=Description%20of%20the%20event&in_loc=Location%20of%20the%20event
